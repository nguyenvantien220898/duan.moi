...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form name ="product" action="{{url('admin/banners')}}" method="post" class="form-horizontal">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnai1" class="form-control" type="text" name="image" value="{{old('image')}}" placeholder="Hình ảnh">
